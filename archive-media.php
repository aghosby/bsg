...
<section class="hero sub__pages">
    ...
    <?php if (get_field('featured_video')) : ?>
        ...
        <?php else : ?>
            <?php if (get_field('media_page_featured_image', 'option')['url']) : ?>
                <img class="hero__img" src="<?= get_field('media_page_featured_image', 'option')['url']; ?>" alt="">
            <?php endif; ?>
    <?php endif; ?>
    ...
    <div class="caption-cont pad-x">
        ...
        <div class="caption__wrap">
            <h1 class="hero__title"><?= get_field('media_page_title', 'option'); ?></h1>
        </div>
    </div>
...
<section class="pad-x py-lg-5 py-3">
    ...
    <form class="filter-form" action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="filter-2">
        <ul class="filter-group">
            ...
            <?php if ($terms = get_terms(array('taxonomy' => 'media-categories', 'orderby' => 'name'))) : ?>
    ...
    <?php if (have_posts()) : ?>
        ...
        <div class="media-wrap md mt-lg-4 mt-3" id="response">
    ...
    <?php else : ?>
        ...
        <div class="sec-hdr lg clr text-center">There are currently no photos or videos to show.</div>
