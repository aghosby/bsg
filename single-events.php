            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    ...
                    <div class="share d-flex align-items-center pt-lg-1 pt-1">
                        <h4 class="sec-hdr sm dark me-0 me-lg-1">Share this event</h4>
                        <?= get_template_part('template-parts/section', 'share'); ?>
                    </div>
                    <div class="sec-text mt-lg-2 mt-2"><?= get_field('intro_preamble') ?></div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="sec-hdr md primary text-center mb-lg-2 mb-2">Other Events</div>
                    <div class="events-wrap justify-content-center align-items-start">
                    <?php
                        // Create query
                        $query_args = array(
                            'post_type' => 'events',
