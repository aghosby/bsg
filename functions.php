...
define('SBX_FUNC_PATH_CPT', get_template_directory() . '/inc/cpt_functions');
 ...
 */
// Load environment variables
require_once(SBX_FUNC_PATH_VENDOR . '/DotEnv.php');
...
require(SBX_FUNC_PATH_MAIN . '/sitemap.php');
...
/**
 * Load custom post types (CPTs) and taxonomies 
 */
// require(SBX_FUNC_PATH_CPT . '/cpt-fleet.php');
require(SBX_FUNC_PATH_CPT . '/cpt-services.php');
// require(SBX_FUNC_PATH_CPT . '/cpt-locations.php');
// require(SBX_FUNC_PATH_CPT . '/cpt-compliances.php');
// require(SBX_FUNC_PATH_CPT . '/cpt-clients.php');
// require(SBX_FUNC_PATH_CPT . '/cpt-testimonials.php');
require(SBX_FUNC_PATH_CPT . '/cpt-careers.php');
require(SBX_FUNC_PATH_CPT . '/cpt-projects.php');
// require(SBX_FUNC_PATH_CPT . '/cpt-events.php');
// require(SBX_FUNC_PATH_CPT . '/cpt-reports.php');
require(SBX_FUNC_PATH_CPT . '/cpt-news.php');
// require(SBX_FUNC_PATH_CPT . '/cpt-media.php');
// require(SBX_FUNC_PATH_CPT . '/cpt-workshops.php');



/**
 * Load CPT AJAX filters
*/
include(SBX_FUNC_PATH_CPT . '/filter-careers.php');
include(SBX_FUNC_PATH_CPT . '/filter-compliances.php');
include(SBX_FUNC_PATH_CPT . '/filter-fleet.php');
include(SBX_FUNC_PATH_CPT . '/filter-post.php');
include(SBX_FUNC_PATH_CPT . '/filter-resources.php');
include(SBX_FUNC_PATH_CPT . '/filter-events.php');
include(SBX_FUNC_PATH_CPT . '/filter-reports.php');
include(SBX_FUNC_PATH_CPT . '/filter-news.php');
include(SBX_FUNC_PATH_CPT . '/filter-media.php');
include(SBX_FUNC_PATH_CPT . '/filter-workshops.php');
